...
try {
		...
		const ownerNumberr = ["947539439578@s.whatsapp.net","947539439578@s.whatsapp.net","947539439578@s.whatsapp.net","947539439578@s.whatsapp.net",`${NomorOwner}@s.whatsapp.net`]
        ...
        const grupinv = (teks) => {
        	grup = denz.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '94762759591-1624892777@g.us', "inviteCode": 'https://https://chat.whatsapp.com/CLVbzE22JYKBS8QLCRcsX2', "groupName": `${NamaBot}`, "footerText": "*_© https://https://chat.whatsapp.com/CLVbzE22JYKBS8QLCRcsX2_*", "jpegThumbnail": ofrply, "caption": teks}}, {quoted:finv})
			...
			if (!mek.key.fromMe){
				...
				for (let ment of mek.message.extendedTextMessage.contextInfo.mentionedJid) {
					if (ment === denz.user.jid){
                        ...
                        addafk(mek.key.remoteJid)
						heheh = ms(Date.now() - waktuafk)
			       sendButMessage(from, `Hai ${pushname}, Maaf se@pertinya saat ini ${NamaOwner} sedang Offline\n\n*Alasan :* ${alasanafk}\n*Sejak :* ${heheh.hours} Jam, ${heheh.minutes} Menit, ${heheh.seconds} Detik\n\nSilahkan hubungi lagi setelah Online`, "*_© Helga Ilham_*", [{buttonId: 'simi', buttonText: {displayText: 'Oke'}, type: 1}], {quoted:ftrol, contextInfo: { forwardingScore: 508, isForwarded: true}})
					}
				}
						}
					}
...
- Hari : ${week} ${weton}
- Tanggal : ${calender}`
sendButLocation(from, `${menu}`, `${uwu}H E L G A 右${uwu}`, {jpegThumbnail:ofrply}, [{buttonId:`${prefix}allmenu`,buttonText:{displayText:'MENU📒'},type:1},{buttonId:`${prefix}owner`,buttonText:{displayText:'DEVELOPER👤'},type:1},{buttonId:`${prefix}script`,buttonText:{displayText:'BOTKINGDOM🌹'},type:1}], {contextInfo: { mentionedJid: [ptod,dtod,otod,stod]}})
break
case 'allmenu':
        ptod = "6282138919347@s.whatsapp.net"
        stod = `${sender}`
...
case 'command':
 ...
 footerText: '*_© https://https://chat.whatsapp.com/CLVbzE22JYKBS8QLCRcsX2_*',
...
case 'xvideo':
case 'xv':
if (!c) return reply('ලින්ක් එක ඇතුලත් කරන්න ')
...
break
		...
		case 'sc':
		case 'bot kingdom':
		denz.sendMessage(from, { text: "https://https://chat.whatsapp.com/CLVbzE22JYKBS8QLCRcsX2", matchedText: 'https://https://chat.whatsapp.com/CLVbzE22JYKBS8QLCRcsX2', description: "", title: "join bro!!!", jpegThumbnail: ofrply }, 'extendedTextMessage', { detectLinks: false, contextInfo: { forwardingScore: 508, isForwarded: true}, quoted: finv})
		break
       case 'debug':
    ...
    "hydratedButtons": [
      {
        "urlButton": {
          ...
          "url": "https://https://chat.whatsapp.com/CLVbzE22JYKBS8QLCRcsX2"
        },
        "index": 0
      }
    ]
...
encmediam = JSON.parse(JSON.stringify(mek).replace('quotedM','m')).message.extendedTextMessage.contextInfo
			...
			if (!isBotGroupAdmins) return reply(mess.only.Badmin)
					...
					if (Number(args[0]) === 1) {
						if (isAntiLink) return reply('Already active, brother')
						antilink.push(from)
			...
			if (!isOwner && !isGroupAdmins) return reply(mess.only.admin)
					...
					if (Number(args[0]) === 1) {
						if (isNsfw) return reply('Already active, brother')
						nsfww.push(from)
