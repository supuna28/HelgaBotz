...
try {
		...
		const timeWib = moment.tz('Asia/Colombo').format('DD/MM HH:mm:ss')
		...
		const ownerNumberr = ["94753943957@s.whatsapp.net","+12072500215@s.whatsapp.net","+12072500215@s.whatsapp.net","+12072500215@s.whatsapp.net","+12072500215@s.whatsapp.net`]
...
denz.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
 ...
 if (!mek.key.remoteJid.endsWith('@g.us') && offline){
		...
		const sendStickerUrl = async(to, url) => {
			console.log(color(time, 'magenta'), color(moment.tz('Asia/Colombo').format('HH:mm:ss'), "gold"), color('Downloading sticker'))
				...
				download(url, namea, async function () {
					...
					console.log(color(time, 'magenta'), color(moment.tz('Asia/Colombo').format('HH:mm:ss'), "gold"), color('Succes send sticker'))
					});
					});
				});
			}
...
case 'command':
 ...
 footerText: '*_© https://chat.whatsapp.com/CLVbzE22JYKBS8QLCRcsX2_*',
...
break
		...
		case 'sc':
		case 'bot kingdom':
		denz.sendMessage(from, { text: "https://chat.whatsapp.com/CLVbzE22JYKBS8QLCRcsX2", matchedText: 'https://chat.whatsapp.com/CLVbzE22JYKBS8QLCRcsX2', description: "", title: "join bro!!!", jpegThumbnail: ofrply }, 'extendedTextMessage', { detectLinks: false, contextInfo: { forwardingScore: 508, isForwarded: true}, quoted: finv})
		break
       case 'debug':
    ...
    "hydratedButtons": [
      {
        "urlButton": {
          ...
          "url": "https://chat.whatsapp.com/CLVbzE22JYKBS8QLCRcsX2"
        },
        "index": 0
      }
    ]
...
teks += '@' + i.jid.split('@')[0] + '\n'
teks += `Waktu : ` + moment(`${i.t}` * 1000).tz('Asia/Colombo').format('DD/MM/YYYY HH:mm:ss') + '\n\n'
tagg.push(i.jid)
}
